                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="dash-pro-item mb-30 dashboard-widget">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form class="contact-form" method="POST" action="{{ route('profile.my-product.store') }}" id="contact_form">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" placeholder="Starting Price" name="starting_price" id="startingPrice">
                                            </div>
                                            <div class="form-group">
                                                <label for="fixedPrice"><i class="fas fa-tag"></i></label>
                                                <input type="number" placeholder="Fixed Price" name="fixed_price" id="fixedPrice">
                                            </div>
                                            <div class="form-group">
                                                <label for="startDatetime"><i class="fas fa-calendar"></i></label>
                                                <input type="date" placeholder="Start Datetime" name="start_datetime" id="startDatetime">
                                            </div>
                                            <div class="form-group">
                                                <label for="endDatetime"><i class="fas fa-calendar"></i></label>
                                                <input type="date" placeholder="end Datetime" name="end_datetime" id="endDatetime">
                                            </div>
                                            <div class="form-group">
                                                <label for="buyerPremiumPercent"><i class="fas fa-percent"></i></label>
                                                <input type="number" placeholder="Buyer Premium Percent" name="buyer_premium_percent" id="buyerPremiumPercent">
                                            </div>
                                            <div class="form-group">
                                                <label for="bidIncrement"><i class="fas fa-chart-line"></i></label>
                                                <input type="number" placeholder="Bid Increment" name="bid_increment" id="bidIncrement">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="delivery_option" id="deliveryOption" placeholder="Delivery Option"></textarea>
                                            </div>
