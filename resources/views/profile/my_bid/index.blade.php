    ...
    <section class="dashboard-section padding-bottom mt--240 mt-lg--325 pos-rel">
        <div class="container">
            <div class="row justify-content-center">
                @include('profile.partials.sidebar', ['current_route' => request()->routeIs('profile.my-bid.*')])
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                                ...
                                <div class="auction-content">
                                    ...
                                    <div class="bid-area">
                                        <div class="bid-amount">
                                            ...
                                            <div class="amount-content">
                                                <div class="current">လက်ရှိလေလံ</div>
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('product.detail', $product->id) }}" class="custom-button">လေလံဆွဲပါ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
